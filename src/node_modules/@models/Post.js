...
//TODO: create Post model that autokeys [slug] from the name String, forcing unique.
const Post = new Schema ({
  ...
  categories: [{ type: mongoose.Schema.Types.ObjectId, ref: 'PostCategory', many: true }],
});
